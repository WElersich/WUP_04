...
Here we have a factor (categorical) variable and a numerical variable. therefore, we should use the boxplot() and favstats() commands to visualize our results.
